...
import files_api_sdk.models
from files_api_sdk import rest
from files_api_sdk.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(files_api_sdk.models, klass)
