...
class DefaultApi:
    ...
    @validate_arguments
    def upload_file_v1_files_file_path_put(self, file_path : StrictStr, file_content : Union[StrictBytes, StrictStr], **kwargs) -> PutFileResponse:  # noqa: E501
        ...
        >>> thread = api.upload_file_v1_files_file_path_put(file_path, file_content, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.upload_file_v1_files_file_path_put_with_http_info(file_path, file_content, **kwargs)  # noqa: E501

    @validate_arguments
    def upload_file_v1_files_file_path_put_with_http_info(self, file_path : StrictStr, file_content : Union[StrictBytes, StrictStr], **kwargs) -> ApiResponse:  # noqa: E501
        """Upload File  # noqa: E501
        ...
        >>> thread = api.upload_file_v1_files_file_path_put_with_http_info(file_path, file_content, async_req=True)
        >>> result = thread.get()
